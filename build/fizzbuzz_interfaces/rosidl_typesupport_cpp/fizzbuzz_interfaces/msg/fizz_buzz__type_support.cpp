...
static const _FizzBuzz_type_support_symbol_names_t _FizzBuzz_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fizzbuzz_interfaces, msg, FizzBuzz)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fizzbuzz_interfaces, msg, FizzBuzz)),
  }
};
...
{
  return &::fizzbuzz_interfaces::msg::rosidl_typesupport_cpp::FizzBuzz_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, fizzbuzz_interfaces, msg, FizzBuzz)() {
  return get_message_type_support_handle<fizzbuzz_interfaces::msg::FizzBuzz>();
}
